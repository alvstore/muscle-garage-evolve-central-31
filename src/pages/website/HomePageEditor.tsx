...
const initialData = {
  heroTitle: "TRANSFORM YOUR BODY AT MUSCLE GARAGE",
  heroSubtitle: "The biggest, most advanced GYM in Ahmedabad with state-of-the-art equipment and professional trainers",
