    ...
    <section id="contact" ref={sectionRef} className="section-padding bg-gym-gray-900">
      <div className="gym-container">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          {/* Contact Form */}
          <div 
            className={`bg-gym-gray-800 rounded-lg p-6 lg:p-8 ${
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 rounded-md bg-gym-gray-700 border border-gym-gray-600 text-white"
          ...
          >
            ...
            <div className="bg-gym-gray-800 rounded-lg overflow-hidden h-[300px]">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d117494.35139554477!2d72.46773550437931!3d23.020497841501823!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e848aba5bd449%3A0x4fcedd11614f6516!2sAhmedabad%2C%20Gujarat!5e0!3m2!1sen!2sin!4v1712536161124!5m2!1sen!2sin"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
