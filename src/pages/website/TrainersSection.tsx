  ...
  const classes = [
    {
      type: "Zumba",
      schedule: [
        { day: "Monday", time: "6:30 AM - 7:30 AM", trainer: "Anjali Kapoor" },
        { day: "Wednesday", time: "6:30 PM - 7:30 PM", trainer: "Anjali Kapoor" },
        { day: "Saturday", time: "10:00 AM - 11:00 AM", trainer: "Anjali Kapoor" }
      ]
    },
    {
      type: "Yoga",
      schedule: [
        { day: "Tuesday", time: "7:00 AM - 8:00 AM", trainer: "Priya Patel" },
        { day: "Thursday", time: "7:00 AM - 8:00 AM", trainer: "Priya Patel" },
        { day: "Sunday", time: "9:00 AM - 10:00 AM", trainer: "Priya Patel" }
      ]
    },
    {
      type: "HIIT",
      schedule: [
        { day: "Monday", time: "7:00 PM - 8:00 PM", trainer: "Vikram Singh" },
        { day: "Thursday", time: "7:00 PM - 8:00 PM", trainer: "Vikram Singh" },
        { day: "Saturday", time: "8:00 AM - 9:00 AM", trainer: "Vikram Singh" }
      ]
    },
    {
      type: "Strength",
      schedule: [
        { day: "Tuesday", time: "6:00 PM - 7:00 PM", trainer: "Rahul Sharma" },
        { day: "Friday", time: "6:00 PM - 7:00 PM", trainer: "Rahul Sharma" },
        { day: "Sunday", time: "5:00 PM - 6:00 PM", trainer: "Rahul Sharma" }
      ]
    }
  ];

  return (
    <section id="trainers" ref={sectionRef} className="section-padding bg-gym-gray-900">
      <div className="gym-container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          {trainers.map((trainer, index) => (
            <div
              key={trainer.name}
              className={`bg-gym-gray-800 rounded-lg overflow-hidden group transition-all duration-500 ${
              ...
              <div className="p-4">
                ...
                <div className="flex flex-wrap gap-2 mt-3">
                  {trainer.specializations.map((spec) => (
                    <span key={spec} className="text-xs bg-gym-gray-700 px-2 py-1 rounded-md">
                      {spec}
                    </span>
                  ))}
                </div>
        ...
        <div className={`${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.6s' }}>
          ...
          <Tabs defaultValue="Zumba">
            <TabsList className="mb-8 w-full flex overflow-x-auto">
              {classes.map((classType) => (
                <TabsTrigger 
                  ...
                  className="flex-1 data-[state=active]:bg-gym-yellow data-[state=active]:text-gym-black"
                >
                  {classType.type}
                </TabsTrigger>
              ))}
            ...
            {classes.map((classType) => (
              <TabsContent key={classType.type} value={classType.type}>
                <div className="bg-gym-gray-800 rounded-lg p-6">
                  ...
                  <div className="space-y-4">
                    {classType.schedule.map((session, idx) => (
                      <div key={idx} className="flex flex-col sm:flex-row justify-between items-start sm:items-center p-4 bg-gym-gray-700 rounded-lg">
                        <div>
