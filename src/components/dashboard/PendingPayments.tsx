              ...
              <div key={payment.id} className="flex items-center justify-between space-x-4">
                <div className="flex items-center space-x-4">
                  <Avatar className="h-9 w-9">
                    <AvatarImage src={payment.member_avatar} alt={payment.member_name || ""} />
                    <AvatarFallback>{getInitials(payment.member_name || "")}</AvatarFallback>
                  </Avatar>
                  <div>
                    <p className="text-sm font-medium leading-none">{payment.member_name}</p>
