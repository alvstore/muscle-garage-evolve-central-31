  ...
  return (
    <div className="sticky top-0 z-30 shadow-sm">
      <div className="flex items-center justify-between h-16 px-4 bg-white dark:bg-gray-900 border-b dark:border-gray-800">
          ...
          <div className="hidden md:flex relative w-64 lg:w-80">
            <div className="relative flex items-center w-full">
              ...
              <Input 
                type="search" 
                placeholder="Search..." 
                className="pl-10 h-9 bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700 w-full"
              />
            </div>
          </div>
        </div>
        ...
        {showSearch && isMobile && (
          <div className="absolute left-0 top-0 w-full p-4 bg-white dark:bg-gray-900 shadow-md flex items-center gap-2 z-50">
            <Input 
              type="search" 
              placeholder="Search..." 
            ...
            <DropdownMenuContent align="end" className="w-80 p-0">
              ...
              <div className="max-h-[400px] overflow-y-auto">
                {notifications.map((notification) => (
                  <DropdownMenuItem key={notification.id} className="flex p-0 focus:bg-transparent">
