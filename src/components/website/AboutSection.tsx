...
const AboutSection = () => {
  ...
  return <section id="about" ref={sectionRef} className="section-padding bg-gym-black">
      <div className="gym-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {facilities.map((facility, index) => <div key={facility.title} className={`bg-gym-gray-800 rounded-lg p-6 shadow-lg transition-all duration-500 hover:shadow-xl hover:bg-gym-gray-700 transform hover:-translate-y-1 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`} style={{
