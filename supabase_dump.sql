...
CREATE OR REPLACE FUNCTION "public"."assign_membership_with_payment"("p_member_id" "uuid", "p_membership_plan_id" "uuid", "p_branch_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone, "p_total_amount" numeric, "p_payment_method" "text", "p_payment_status" "text", "p_notes" "text", "p_recorded_by" "uuid") RETURNS "jsonb"
...
BEGIN
  ...
  -- First try to get a branch-specific category, fall back to global (NULL branch_id)
  SELECT id INTO v_category_id
  FROM public.income_categories
  WHERE name = 'Membership' 
  AND (branch_id = p_branch_id OR branch_id IS NULL)
  ORDER BY 
    CASE WHEN branch_id IS NULL THEN 1 ELSE 0 END  -- Prefer branch-specific over global
  LIMIT 1;
  
  IF v_category_id IS NULL THEN
    -- If no category exists for this branch or globally, create a branch-specific one
...
ALTER FUNCTION "public"."assign_membership_with_payment"("p_member_id" "uuid", "p_membership_plan_id" "uuid", "p_branch_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone, "p_total_amount" numeric, "p_payment_method" "text", "p_payment_status" "text", "p_notes" "text", "p_recorded_by" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."assign_membership_with_payment"("p_member_id" "uuid", "p_membership_plan_id" "uuid", "p_branch_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone, "p_total_amount" numeric, "p_payment_method" "text", "p_payment_status" "text", "p_transaction_id" "text" DEFAULT NULL::"text", "p_reference_number" "text" DEFAULT NULL::"text", "p_notes" "text" DEFAULT NULL::"text", "p_recorded_by" "uuid" DEFAULT NULL::"uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_membership_id uuid;
...
ALTER FUNCTION "public"."assign_membership_with_payment"("p_member_id" "uuid", "p_membership_plan_id" "uuid", "p_branch_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone, "p_total_amount" numeric, "p_payment_method" "text", "p_payment_status" "text", "p_transaction_id" "text", "p_reference_number" "text", "p_notes" "text", "p_recorded_by" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."check_active_memberships"("p_member_id" "uuid", "p_date" timestamp with time zone) RETURNS TABLE("id" "uuid", "membership_id" "uuid", "start_date" "date", "end_date" "date", "status" "text")
    LANGUAGE "sql"
    AS $$
  SELECT 
    mm.id,
    ...
    mm.status
  FROM 
    member_memberships mm
  WHERE 
    mm.member_id = p_member_id
    AND mm.status = 'active'
    AND mm.start_date <= (p_date AT TIME ZONE 'UTC')::date
    AND mm.end_date >= (p_date AT TIME ZONE 'UTC')::date;
$$;


ALTER FUNCTION "public"."check_active_memberships"("p_member_id" "uuid", "p_date" timestamp with time zone) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."cleanup_profiles_table"() RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    -- This function can be run after verifying the migration was successful
    -- It will remove role-specific columns from the profiles table
    -- ALTER TABLE public.profiles DROP COLUMN IF EXISTS some_staff_specific_column;
    -- ALTER TABLE public.profiles DROP COLUMN IF EXISTS some_trainer_specific_column;
    
    -- For now, we'll just log a message
    RAISE NOTICE 'Profile cleanup function executed. Review and modify as needed.';
END;
$$;


ALTER FUNCTION "public"."cleanup_profiles_table"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."delete_trainer"("trainer_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."delete_trainer"("trainer_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_trainer_profile"("p_trainer_id" "uuid") RETURNS "jsonb"
    LANGUAGE "sql" STABLE
    AS $$
  SELECT jsonb_build_object(
    'profile', to_jsonb(p.*) - 'password',
    'trainer', to_jsonb(t.*) - 'profile_id',
    'documents', (
      SELECT COALESCE(jsonb_agg(to_jsonb(d.*)), '[]'::jsonb)
      FROM public.trainer_documents d
      WHERE d.trainer_id = t.id
    ),
    'schedule', (
      SELECT COALESCE(jsonb_agg(to_jsonb(s.*)), '[]'::jsonb)
      FROM public.trainer_schedule s
      WHERE s.trainer_id = t.id
    ),
    'rating', jsonb_build_object(
      'average', COALESCE(t.rating_average, 0.0),
      'count', COALESCE(t.rating_count, 0)
    )
  )
...
ALTER FUNCTION "public"."get_trainer_profile"("p_trainer_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."handle_user_role"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
    -- For staff table
    IF TG_TABLE_NAME = 'staff' THEN
        -- Insert or update the user_role
...
ALTER FUNCTION "public"."handle_user_role"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_trainer_rating"("p_trainer_id" "uuid", "new_rating" numeric) RETURNS "jsonb"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
BEGIN
  ...
  IF v_count = 0 THEN
    v_new_avg := new_rating;
  ELSE
    v_new_avg := ((v_current_avg * v_count) + new_rating) / (v_count + 1);
  END IF;
...
ALTER FUNCTION "public"."update_trainer_rating"("p_trainer_id" "uuid", "new_rating" numeric) OWNER TO "postgres";
...
COMMENT ON COLUMN "public"."profiles"."id_type" IS 'Type of identification document (e.g., Aadhaar, PAN, Passport)';



COMMENT ON COLUMN "public"."profiles"."id_number" IS 'Identification number for verification';
...
COMMENT ON TABLE "public"."staff" IS 'Stores staff-specific information separate from profiles';
...
CREATE OR REPLACE VIEW "public"."staff_with_users" AS
 SELECT "s"."id",
    "s"."user_id",
    "s"."employee_id",
    "s"."hire_date",
...
ALTER TABLE "public"."staff_with_users" OWNER TO "postgres";
...
ALTER TABLE "public"."trainer_documents" OWNER TO "postgres";
...
ALTER TABLE "public"."trainer_schedule" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."trainers" (
    ...
    "emergency_contact" "jsonb" DEFAULT '{"name": "", "phone": "", "address": "", "relation": ""}'::"jsonb",
    "bank_details" "jsonb" DEFAULT '{"branch": "", "bank_name": "", "ifsc_code": "", "account_holder": "", "account_number": ""}'::"jsonb",
    "is_active" boolean DEFAULT true,
...
COMMENT ON TABLE "public"."trainers" IS 'Stores trainer-specific information linked to user profiles';



CREATE OR REPLACE VIEW "public"."trainers_with_users" AS
 SELECT "t"."id",
    "t"."profile_id",
    "t"."employee_id",
    "t"."hire_date",
...
ALTER TABLE "public"."trainers_with_users" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."trainer_schedule"
    ADD CONSTRAINT "trainer_schedule_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."trainers"
    ADD CONSTRAINT "trainers_employee_id_key" UNIQUE ("employee_id");
...
CREATE INDEX "idx_trainer_documents_trainer" ON "public"."trainer_documents" USING "btree" ("trainer_id");



CREATE INDEX "idx_trainer_documents_type" ON "public"."trainer_documents" USING "btree" ("document_type");



CREATE INDEX "idx_trainer_schedule_day" ON "public"."trainer_schedule" USING "btree" ("day_of_week");



CREATE INDEX "idx_trainer_schedule_trainer" ON "public"."trainer_schedule" USING "btree" ("trainer_id");



CREATE INDEX "idx_trainers_employee_id" ON "public"."trainers" USING "btree" ("employee_id");
...
CREATE INDEX "idx_trainers_profile_id" ON "public"."trainers" USING "btree" ("profile_id");
...
CREATE OR REPLACE TRIGGER "trigger_staff_role" AFTER INSERT OR UPDATE ON "public"."staff" FOR EACH ROW EXECUTE FUNCTION "public"."handle_user_role"();



CREATE OR REPLACE TRIGGER "trigger_trainer_role" AFTER INSERT OR UPDATE ON "public"."trainers" FOR EACH ROW EXECUTE FUNCTION "public"."handle_user_role"();
...
ALTER TABLE ONLY "public"."leads"
    ADD CONSTRAINT "fk_leads_branch_id" FOREIGN KEY ("branch_id") REFERENCES "public"."branches"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."trainer_documents"
    ADD CONSTRAINT "trainer_documents_trainer_id_fkey" FOREIGN KEY ("trainer_id") REFERENCES "public"."trainers"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."trainer_documents"
    ADD CONSTRAINT "trainer_documents_verified_by_fkey" FOREIGN KEY ("verified_by") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."trainer_schedule"
    ADD CONSTRAINT "trainer_schedule_trainer_id_fkey" FOREIGN KEY ("trainer_id") REFERENCES "public"."trainers"("id") ON DELETE CASCADE;
...
CREATE POLICY "Admins can insert staff" ON "public"."staff" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."user_roles"
  WHERE (("user_roles"."user_id" = "auth"."uid"()) AND ("user_roles"."role" = 'admin'::"public"."user_role")))));



CREATE POLICY "Admins can insert trainers" ON "public"."trainers" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."user_roles"
  WHERE (("user_roles"."user_id" = "auth"."uid"()) AND ("user_roles"."role" = 'admin'::"public"."user_role")))));
...
CREATE POLICY "Admins can manage all trainers" ON "public"."trainers" USING (("auth"."uid"() IN ( SELECT "user_roles"."user_id"
   FROM "public"."user_roles"
  WHERE ("user_roles"."role" = 'admin'::"public"."user_role"))));
...
CREATE POLICY "Admins can update staff" ON "public"."staff" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."user_roles"
  WHERE (("user_roles"."user_id" = "auth"."uid"()) AND ("user_roles"."role" = 'admin'::"public"."user_role")))));



CREATE POLICY "Admins can update trainers" ON "public"."trainers" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."user_roles"
  WHERE (("user_roles"."user_id" = "auth"."uid"()) AND ("user_roles"."role" = 'admin'::"public"."user_role")))));
...
CREATE POLICY "Admins can view all staff" ON "public"."staff" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."user_roles"
  WHERE (("user_roles"."user_id" = "auth"."uid"()) AND ("user_roles"."role" = 'admin'::"public"."user_role")))));



CREATE POLICY "Admins can view all trainers" ON "public"."trainers" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."user_roles"
  WHERE (("user_roles"."user_id" = "auth"."uid"()) AND ("user_roles"."role" = 'admin'::"public"."user_role")))));
...
CREATE POLICY "Trainers can manage their own schedule" ON "public"."trainer_schedule" USING (("auth"."uid"() = ( SELECT "trainers"."profile_id"
   FROM "public"."trainers"
  WHERE ("trainers"."id" = "trainer_schedule"."trainer_id"))));
...
CREATE POLICY "Trainers can update own record" ON "public"."trainers" FOR UPDATE USING (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Trainers can view own record" ON "public"."trainers" FOR SELECT USING (("user_id" = "auth"."uid"()));
...
CREATE POLICY "Trainers can view their own documents" ON "public"."trainer_documents" FOR SELECT USING (("auth"."uid"() = ( SELECT "trainers"."profile_id"
   FROM "public"."trainers"
  WHERE ("trainers"."id" = "trainer_documents"."trainer_id"))));



CREATE POLICY "Trainers can view their own profile" ON "public"."trainers" FOR SELECT USING (("auth"."uid"() = ( SELECT "profiles"."id"
   FROM "public"."profiles"
  WHERE ("profiles"."id" = "trainers"."profile_id"))));
...
GRANT ALL ON FUNCTION "public"."assign_membership_with_payment"("p_member_id" "uuid", "p_membership_plan_id" "uuid", "p_branch_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone, "p_total_amount" numeric, "p_payment_method" "text", "p_payment_status" "text", "p_notes" "text", "p_recorded_by" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."assign_membership_with_payment"("p_member_id" "uuid", "p_membership_plan_id" "uuid", "p_branch_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone, "p_total_amount" numeric, "p_payment_method" "text", "p_payment_status" "text", "p_notes" "text", "p_recorded_by" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."assign_membership_with_payment"("p_member_id" "uuid", "p_membership_plan_id" "uuid", "p_branch_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone, "p_total_amount" numeric, "p_payment_method" "text", "p_payment_status" "text", "p_notes" "text", "p_recorded_by" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."assign_membership_with_payment"("p_member_id" "uuid", "p_membership_plan_id" "uuid", "p_branch_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone, "p_total_amount" numeric, "p_payment_method" "text", "p_payment_status" "text", "p_transaction_id" "text", "p_reference_number" "text", "p_notes" "text", "p_recorded_by" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."assign_membership_with_payment"("p_member_id" "uuid", "p_membership_plan_id" "uuid", "p_branch_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone, "p_total_amount" numeric, "p_payment_method" "text", "p_payment_status" "text", "p_transaction_id" "text", "p_reference_number" "text", "p_notes" "text", "p_recorded_by" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."assign_membership_with_payment"("p_member_id" "uuid", "p_membership_plan_id" "uuid", "p_branch_id" "uuid", "p_start_date" timestamp with time zone, "p_end_date" timestamp with time zone, "p_total_amount" numeric, "p_payment_method" "text", "p_payment_status" "text", "p_transaction_id" "text", "p_reference_number" "text", "p_notes" "text", "p_recorded_by" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."check_active_memberships"("p_member_id" "uuid", "p_date" timestamp with time zone) TO "anon";
GRANT ALL ON FUNCTION "public"."check_active_memberships"("p_member_id" "uuid", "p_date" timestamp with time zone) TO "authenticated";
GRANT ALL ON FUNCTION "public"."check_active_memberships"("p_member_id" "uuid", "p_date" timestamp with time zone) TO "service_role";



GRANT ALL ON FUNCTION "public"."cleanup_profiles_table"() TO "anon";
GRANT ALL ON FUNCTION "public"."cleanup_profiles_table"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."cleanup_profiles_table"() TO "service_role";



GRANT ALL ON FUNCTION "public"."delete_trainer"("trainer_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."delete_trainer"("trainer_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."delete_trainer"("trainer_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_trainer_profile"("p_trainer_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_trainer_profile"("p_trainer_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_trainer_profile"("p_trainer_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."handle_user_role"() TO "anon";
GRANT ALL ON FUNCTION "public"."handle_user_role"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."handle_user_role"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_trainer_rating"("p_trainer_id" "uuid", "new_rating" numeric) TO "anon";
GRANT ALL ON FUNCTION "public"."update_trainer_rating"("p_trainer_id" "uuid", "new_rating" numeric) TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_trainer_rating"("p_trainer_id" "uuid", "new_rating" numeric) TO "service_role";
...
GRANT ALL ON TABLE "public"."staff_with_users" TO "anon";
GRANT ALL ON TABLE "public"."staff_with_users" TO "authenticated";
GRANT ALL ON TABLE "public"."staff_with_users" TO "service_role";
...
GRANT ALL ON TABLE "public"."trainer_documents" TO "anon";
GRANT ALL ON TABLE "public"."trainer_documents" TO "authenticated";
GRANT ALL ON TABLE "public"."trainer_documents" TO "service_role";



GRANT ALL ON TABLE "public"."trainer_schedule" TO "anon";
GRANT ALL ON TABLE "public"."trainer_schedule" TO "authenticated";
GRANT ALL ON TABLE "public"."trainer_schedule" TO "service_role";
...
GRANT ALL ON TABLE "public"."trainers_with_users" TO "anon";
GRANT ALL ON TABLE "public"."trainers_with_users" TO "authenticated";
GRANT ALL ON TABLE "public"."trainers_with_users" TO "service_role";
